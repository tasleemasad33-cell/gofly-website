...
export function PackageListingSection({
  ...
  return (
    <section id="tour-listing" className="py-20">
        ...
        <div className="mt-12">
          ...
          {totalPages > 1 && (
            <div className="mt-10 flex items-center justify-center gap-2">
              <button
                onClick={() => { setPage((p) => Math.max(1, p - 1)); document.getElementById("tour-listing")?.scrollIntoView({ behavior: "smooth" }); }}
                disabled={page === 1}
              ...
              {Array.from({ length: totalPages }, (_, i) => i + 1).map((n) => (
                <button
                  key={n}
                  onClick={() => { setPage(n); document.getElementById("tour-listing")?.scrollIntoView({ behavior: "smooth" }); }}
              ...
              <button
                onClick={() => { setPage((p) => Math.min(totalPages, p + 1)); document.getElementById("tour-listing")?.scrollIntoView({ behavior: "smooth" }); }}
